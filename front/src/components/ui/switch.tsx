  ...
  return (
    <SwitchPrimitive.Root
      ...
      className={cn(
        ...
        color === 'bg-sunset-active' && 'data-[state=checked]:bg-sunset-active',
        color === 'bg-night-active' && 'data-[state=checked]:bg-night-active',
        color === 'bg-primary' && 'data-[state=checked]:bg-primary',
